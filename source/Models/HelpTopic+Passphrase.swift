    ...
    static let passphraseAndTouchID = HelpTopic(
        ...
        sections: [
            ...
            HelpSection("Recovery", [
                ...
                .paragraph("If you saved the passphrase in macOS Keychain, you can read it back: click **Open Keychain Access…** in the Recovery section, then search for *GnuPG*. The entries are labelled with their key's User ID and short fingerprint so they're easy to identify."),
